...
\vfill{}
{\par\centering \textsc{\LARGE Zero to Monero \\Privacy in the blockchain: First Edition \\Draft 0.0.10}\par}
\bigskip
...
%\footnote{\label{donation-request}Dear reader,\par
%Welcome to our report, we hope you enjoy it!\\
%Do you feel Monero has enough documentation? Are there enough in-depth reference materials?
%If you find this report valuable you can donate XMR, empowering us to continue expanding and perfecting this report, and to assemble new reports, here:\\
%-----integrated address w/ payment ID 'z 2 m 1st ed' -> binary
%Your generosity is a great honor to us, thank you!\\
%
%P.S. This is an integrated address, which you will find described in Section \ref{sec:integrated-addresses}.
%author notes: email addresses? and do superscript ref{donation-request}
...
%\include{content/Monero-cryptocurrency}
